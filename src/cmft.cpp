...
#include "macros.h" //countof
#include "utils.h" //strncpy
...
void printHelp()
{
    ...
    fprintf(stderr
          , "Usage: cmft [options]\n"
            ...
            "          blinn\n"
            "          blinnbrdf\n"
            "    --numCpuProcessingThreads <uint>   Should not be bigger than the number of physical CPU cores/threads. If <uint> == 0, CPU will not be used for filtering. [radiance filter param]\n"

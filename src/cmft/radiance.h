...
namespace cmft
{
    static const char sc_radianceProgramSource[] =
    {
        ...
        "};\n"
        "\n"
        "static float3 texelCoordToVecWarp(float _u\n"
        "                                , float _v\n"
        "                                , int8_t _faceId\n"
        "                                , float _warp\n"
        "                                )\n"
        ...
        "    const float vv = ((float)row    + 0.5f)*invDstFaceSize_Mul2 - 1.0f;\n"
        "    const float uu = ((float)column + 0.5f)*invDstFaceSize_Mul2 - 1.0f;\n"
        "    const float3 tapVec = texelCoordToVecWarp(uu, vv, _faceId, _warp);\n"
        "\n"
